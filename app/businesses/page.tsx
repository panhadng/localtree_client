      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-3xl font-bold text-[#185659]">Local Businesses</h1>
            <Link href="/list-business" className="bg-[#ed8c15] text-white px-4 py-2 rounded-lg hover:bg-[#f39c2b] transition-colors">
              List Business
            </Link>
          </div>
        ...
        <div className="mt-8 flex justify-center">
          <nav className="flex items-center gap-2">
            <button className="px-3 py-2 text-sm text-gray-500 hover:text-[#185659]">Previous</button>
            <button className="px-3 py-2 text-sm bg-[#185659] text-white rounded">1</button>
            <button className="px-3 py-2 text-sm text-gray-700 hover:text-[#185659]">2</button>
            <button className="px-3 py-2 text-sm text-gray-700 hover:text-[#185659]">3</button>
            <button className="px-3 py-2 text-sm text-gray-500 hover:text-[#185659]">Next</button>
          </nav>
        </div>
      </div>
    </div>
